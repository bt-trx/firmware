...
TEST_F(WT32i_parseMessageString_Test, parseMessageString_success_LIST) {
  WT32i wt32i(nullptr);
  iWrapMessage msg;
  string input = "LIST 0 CONNECTED HFP-AG 667 0 0 7 8d 8d 25:aa:92:1f:94:a8 3 INCOMING ACTIVE SLAVE ENCRYPTED 0";
...
TEST_F(WT32i_parseMessageString_Test, parseMessageString_success_HFPAG_NO_CARRIER) {
  WT32i wt32i(nullptr);
  iWrapMessage msg;
...
TEST_F(WT32i_parseMessageString_Test, parseMessageString_success_NO_CARRIER_1_ERROR_0) {
  WT32i wt32i(nullptr);
  iWrapMessage msg;
...
TEST_F(WT32i_parseMessageString_Test, parseMessageString_success_NO_CARRIER_0_ERROR_L2CAP_LINK_LOSS) {
  WT32i wt32i(nullptr);
  iWrapMessage msg;
...
TEST_F(WT32i_parseMessageString_Test, parseMessageString_success_NO_CARRIER_0_ERROR_0) {
  WT32i wt32i(nullptr);
  iWrapMessage msg;
